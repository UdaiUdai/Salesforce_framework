...
public class NewLeadTest extends ProjectSpecificMethods {
	...
	// (see excelFileName above) with header row: username, password, expectedTitle, searchAppsAndItems, firstName, lastName, company, title, city, street, zipPostalCode, annualRevenue, noOfEmployees
	...
	public void verifyNavigationToCreateLead(String username, String password, String expectedTitle, String searchAppsAndItems, String firstName, String lastName, String company, String title, String city, String street, String zipPostalCode, String annualRevenue, String noOfEmployees) {
			new LoginPage()
				.enterUname(username)
				.enterPwd(password)
				.clickLogin();
			...
			new CreateLeadPage()
				...
				.clickLeadSourceWeb()
				.clickIndustry()
				.clickIndustryEducation()
				.typeAnnualRevenue(annualRevenue)
				.typeNoOfEmployees(noOfEmployees)
				.clickSave()
				.verifyMrTestUserDisplayed();
	}
}
